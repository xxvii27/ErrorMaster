...
if($option === "pass"){
    $newpass = mysql_real_escape_string(htmlentities(substr(urldecode(gpc("password")),0,1024)));
    ...
    $newcode = mysql_real_escape_string(htmlentities(substr(urldecode(gpc("code")),0,1024)));
